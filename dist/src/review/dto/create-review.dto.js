...
__decorate([
    (0, class_validator_1.IsNotEmpty)({ message: 'nameProduct can not be empty' }),
    (0, class_validator_1.IsString)({ message: 'nameProduct should be string ' }),
...
__decorate([
    (0, class_validator_1.IsNotEmpty)({ message: 'comment should not empty' }),
