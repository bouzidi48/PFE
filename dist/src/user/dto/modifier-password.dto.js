...
__decorate([
    (0, class_validator_1.IsNotEmpty)({ message: 'confirmpassword is Empty' }),
    (0, class_validator_1.IsString)({ message: 'confirmpassword must be a string' }),
    __metadata("design:type", String)
], UpdatePasswordDto.prototype, "confirmpassword", void 0);
//# sourceMappingURL=modifier-password.dto.js.map